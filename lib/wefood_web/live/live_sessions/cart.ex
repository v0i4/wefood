defmodule LiveSession.Cart do
  ...
  defp create_cart(socket, cart_id) do
    ...
    cart_id = build_card_id(current_user, cart_id)
  ...
  def build_card_id(nil, nil) do
    cart_id = Ecto.UUID.generate()
    Carts.create(cart_id)
    cart_id
  end

  def build_card_id(nil, cart_id) do
    Carts.create(cart_id)
    cart_id
  end

  def build_card_id(%{id: cart_id}, _cart_id) do
    Carts.create(cart_id)
    cart_id
  end
end
